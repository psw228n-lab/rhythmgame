globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/layout-segment-context-CgafN64X.js","assets/RhythmGame-CYmV0CxI.js"];
...
function getDraftSecret() {
	return "f234e950-291b-46e5-a71d-0c9ca62bf7c7";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "8f1a1d12-84ed-417b-93d2-4e83b6debf53";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "8f1a1d12-84ed-417b-93d2-4e83b6debf53") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "8f1a1d12-84ed-417b-93d2-4e83b6debf53",
		rootBoundaryId
	});
}
/**
...
var RhythmGame_default = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'default' is called on server");
}, "ae21d9fed64a", "default");
//#endregion
//#region app/page.tsx
var page_exports = /* @__PURE__ */ __exportAll({ default: () => Home });
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)(RhythmGame_default, {});
}
...
async function generateMetadata() {
	...
	const origin = `${requestHeaders.get("x-forwarded-proto") ?? "https"}://${requestHeaders.get("host") ?? "afterglow.local"}`;
